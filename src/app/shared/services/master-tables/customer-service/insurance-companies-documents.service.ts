...
export class InsuranceCompaniesDocumentsService {
  ...
  getInsuranceCompaniesDocuments(
    data: IInsuranceCompaniesDocumentsData
  ): Observable<HttpResponse<IBaseResponse<IInsuranceCompaniesDocuments[]>>> {
    return this.http.post<IBaseResponse<IInsuranceCompaniesDocuments[]>>(
      this.env +
