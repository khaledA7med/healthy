...
export class CompanyRequirementsService {
  ...
  ): Observable<HttpResponse<IBaseResponse<ICompanyRequirementsFilter[]>>> {
    return this.http.post<IBaseResponse<ICompanyRequirementsFilter[]>>(
      this.env +
        ApiRoutes.masterTables.customerService.customerServiceRequirements
          .search,
      data,
      {
        observe: "response",
