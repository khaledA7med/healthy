...
export class ListOfRequiredDocumentsService {
  ...
  getClientsDocuments(): Observable<
    HttpResponse<IBaseResponse<IClientDocumentFilter[]>>
  > {
  ...
  saveClientsDocuments(
    data: IClientDocumentReq
  ): Observable<IBaseResponse<any>> {
    return this.http.post<IBaseResponse<any>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.clients.save,
      { ...data }
    );
  }

  editClientsDocuments(
    id: string
  ): Observable<IBaseResponse<IClientDocumentReq>> {
    return this.http.get<IBaseResponse<IClientDocumentReq>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.clients.edit,
      {
        params: { id },
      }
    );
  ...
  getClaimsDocuments(data: {
    insurClass: string;
    lineOfBusiness: string;
  }): Observable<HttpResponse<IBaseResponse<IClaimsDocumentFilter[]>>> {
  ...
  saveClaimsDocuments(
    ...
    return this.http.post<IBaseResponse<number>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.claims.save,
      { ...data }
    );
  }
  ...
  editClaimsDocuments(
    id: string
  ): Observable<IBaseResponse<IClaimsDocumentReq>> {
    return this.http.get<IBaseResponse<IClaimsDocumentReq>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.claims.edit,
      {
        params: { id },
      }
    );
  ...
  getPoliciesDocuments(
    PolicyIssueType: string
  ): Observable<HttpResponse<IBaseResponse<IPoliciesDocumentFilter[]>>> {
  ...
  savePoliciesDocuments(
    data: IPoliciesDocumentReq
  ): Observable<IBaseResponse<any>> {
    return this.http.post<IBaseResponse<any>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.production.save,
      { ...data }
    );
  }

  editPoliciesDocuments(
    id: string
  ): Observable<IBaseResponse<IPoliciesDocumentReq>> {
    return this.http.get<IBaseResponse<IPoliciesDocumentReq>>(
      this.env + ApiRoutes.masterTables.listOfDocuments.production.edit,
      {
        params: { id },
      }
    );
