...
import { ICustomerServiceFollowUp, ICustomerServiceFollowUpData } from "../../app/models/CustomerService/icustomer-service-followup";
...
export class CustomerServiceService {
	...
	saveNote(data: ICustomerServiceFollowUpData): Observable<IBaseResponse<any>> {
