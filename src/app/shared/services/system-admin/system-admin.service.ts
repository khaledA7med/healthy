...
export class SystemAdminService {
  ...
  getUserDetails(
    sno: number
  ): Observable<HttpResponse<IBaseResponse<UserDetails>>> {
    return this.http.get<IBaseResponse<UserDetails>>(
      this.env + ApiRoutes.SystemAdmin.userDetails,
  ...
  getEditUserData(
    id: string
  ): Observable<HttpResponse<IBaseResponse<UserModelData>>> {
    return this.http.get<IBaseResponse<UserDetails>>(
      this.env + ApiRoutes.SystemAdmin.edit,
  ...
  saveUser(
    ...
    return this.http.post<IBaseResponse<number>>(
      this.env + ApiRoutes.SystemAdmin.save,
      data,
      { observe: "response" }
    );
  }
