...
import { IClaimSummary } from "../../app/models/Claims/iclaim-summary";
...
export class ClaimsService {
  ...
  viewCSReport(
    body: claimsReportReq
  ): Observable<HttpResponse<IBaseResponse<number>>> {
    return this.http.post<IBaseResponse<number>>(
      this.env + ApiRoutes.Claims.claimsReport,
      body,
      {
        observe: "response",
      }
  ...
  viewArchiveNoteReport(
    body: IClaimsNoteReport
  ): Observable<HttpResponse<IBaseResponse<number>>> {
    return this.http.post<IBaseResponse<number>>(
      this.env + ApiRoutes.Claims.archiveReport,
      body,
      {
        observe: "response",
      }
  ...
  getClaimSummary(types: string[]): Observable<IBaseResponse<IClaimSummary>> {
    return this.http.post<IBaseResponse<IClaimSummary>>(
      this.env + ApiRoutes.Claims.summary,
      {
        claimType: types,
      }
    );
