		...
		return [
			{
				...
				auth: privileges.MasterTables?.includes(MasterTablePermissions.ChMasterTabels),
				subItems: [
					{
						id: 101,
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChIncuranceClasses),
					},
					{
						id: 102,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChInsuranceCompanies),
					},
					{
						id: 104,
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChInsuranceBrokers),
					},
					{
						id: 105,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChBusinessActivity),
					},
					{
						id: 108,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChClientsCategories),
					},
					{
						id: 112,
						label: "MENUITEMS.MASTERTABLE.LIST.CUSTOMERSERVICE.TEXT",
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChCustomerServiceModule),
						subItems: [
							{
								id: 1012,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChProductionBusinessModules),
						subItems: [
							{
								id: 1013,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChClaimsModule),
						subItems: [
							{
								id: 1014,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChListOfRequiredDocuments),
						subItems: [
							{
								id: 1015,
					...
					},
					{
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChContactsListPosition),
					},
					{
						id: 118,
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChCountries),
					},
					{
						id: 119,
						...
						parentId: 1,
						auth: privileges.MasterTables?.includes(MasterTablePermissions.ChDefaultEmails),
					},
					{
						id: 120,
			...
			},
			{
				...
				auth: privileges.Clients?.includes(ClientsPermissions.ChClientsRegistryAdmin),
				subItems: [
					{
						id: 201,
						...
						parentId: 2,
						auth: privileges.Clients?.includes(ClientsPermissions.ChClientsRegistry),
					},
					{
						id: 202,
						...
						parentId: 2,
						auth: privileges.Clients?.includes(ClientsPermissions.ChClientsGrouping),
					},
					{
						id: 203,
			...
			},
			{
				...
				subItems: [
					...
					// },
					{
						...
						parentId: 3,
						auth: privileges.BussinessDevelopment?.includes(BusinessDevelopmentPermissions.ChBussDevelopment),
					},
					{
						id: 302,
						label: "MENUITEMS.BUSINESSDEVELOPMENT.LIST.REPORTS",
						parentId: 3,
						auth: privileges.BussinessDevelopment?.includes(BusinessDevelopmentPermissions.ChBusinessReports),
						subItems: [
							{
								id: 3001,
			...
			},
			{
				...
				icon: "bx bx-layer",
				auth: privileges.Production?.includes(ProductionPermissions.ChProduction),
				subItems: [
					{
						id: 401,
						...
						parentId: 4,
						auth: privileges.Production?.includes(ProductionPermissions.ChProdPolicies),
					},
					{
						id: 402,
					...
					},
					{
						...
						parentId: 4,
						auth: privileges.Production?.includes(ProductionPermissions.ChChangeProducerComm),
					},
					{
						id: 404,
						label: "MENUITEMS.PRODUCTION.LIST.REPORTS",
						parentId: 4,
						auth: privileges.Production?.includes(ProductionPermissions.ChProdReports),
						subItems: [
							{
								id: 4001,
			...
			},
			{
				...
				auth: privileges.CustomerService?.includes(CustomerServicePermissions.ChCustomerService),
				subItems: [
					{
						id: 501,
						...
						parentId: 5,
						auth: privileges.CustomerService?.includes(CustomerServicePermissions.ChRequestsManagements),
					},
					{
						id: 502,
						...
						parentId: 5,
						auth: privileges.CustomerService?.includes(CustomerServicePermissions.ChCustSerReports),
					},
				],
			},
			{
				...
				subItems: [
					{
						...
						parentId: 6,
						auth: privileges.Claims?.includes(ClaimsPermissions.ChClaimsManagement),
					},
					{
						id: 602,
