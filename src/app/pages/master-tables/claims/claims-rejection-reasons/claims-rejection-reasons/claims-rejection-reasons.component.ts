...
export class ClaimsRejectionReasonsComponent implements OnInit, OnDestroy {
  ...
  @ViewChild("ClaimsRejectionReasonsContent")
  ...
  dataSource: IDatasource = {
    getRows: (params: IGetRowsParams) => {
      ...
      let sub = this.ClaimsRejectionReasonsService.getClaimsRejectionReasons(
        this.uiState.type
      ).subscribe(
  ...
  openClaimsRejectionReasonsDialoge(sno: number) {
    ...
    this.ClaimsRejectionReasonsModal = this.modalService.open(
      this.ClaimsRejectionReasonsContent,
      {
  ...
  submitClaimsRejectionReasonsData(form: FormGroup) {
    ...
    const data: IClaimsRejectionReasonsData = {
      sno: this.uiState.editClaimsRejectionReasonsMode
        ? this.uiState.editClaimsRejectionReasonsData.sno
        : 0,
      type: formData.type,
