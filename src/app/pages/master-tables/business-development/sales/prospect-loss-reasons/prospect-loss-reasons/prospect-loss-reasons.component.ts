...
export class ProspectLossReasonsComponent implements OnInit, OnDestroy
{
  ...
  dataSource: IDatasource = {
    getRows: (params: IGetRowsParams) =>
    {
      ...
      let sub = this.ProspectLossReasonsService.getProspectLossReasons().subscribe(
  ...
  submitProspectLossReasonsData (form: FormGroup)
  {
    ...
    this.eventService.broadcast(reserved.isLoading, true);
    let sub = this.ProspectLossReasonsService.saveProspectLossReasons(data).subscribe(
  ...
  {
    let sub = this.ProspectLossReasonsService.DeleteProspectLossReasons(id).subscribe(
