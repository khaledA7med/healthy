...
import { CompanyRejectionReasonsComponent } from './company-rejection-reasons.component';

@Component({
  selector: 'app-company-rejection-reasons-forms',
  template: `
  <div class="col">
...
export class CompanyRejectionReasonsFormsComponent
{

  private params!: ICellRendererParams;
  private comp!: CompanyRejectionReasonsComponent;
  ...
  Edit ()
  {
    this.comp.openCompanyRejectionReasonsDialoge(this.params.data.identity);
  }
