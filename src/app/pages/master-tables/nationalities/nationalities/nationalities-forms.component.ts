...
@Component({
  selector: "app-nationalities-forms",
  template: `
...
export class NationalitiesFormsComponent {
  private params!: ICellRendererParams;
  private comp!: NationalitiesComponent;
  ...
  Edit() {
    this.comp.openNationalitiesDialoge(this.params.data.identity);
  }
    ...
    this.message
      ...
      .then((result: SweetAlertResult) => {
        if (result.isConfirmed) {
          this.comp.DeleteNationalities(this.params.data.identity);
        } else {
          return;
        }
      });
