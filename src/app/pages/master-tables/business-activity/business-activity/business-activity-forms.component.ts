...
@Component({
  selector: "app-business-activity-forms",
  template: `
...
export class BusinessActivityFormsComponent {
  private params!: ICellRendererParams;
  private comp!: BusinessActivityComponent;
  ...
  Edit() {
    this.comp.openBusinessActivityDialoge(this.params.data.identity);
  }
    ...
    this.message
      ...
      .then((result: SweetAlertResult) => {
        if (result.isConfirmed) {
          this.comp.DeleteBusinessActivity(this.params.data.identity);
        } else {
          return;
        }
      });
