...
@Component({
	selector: "app-clients-Documents-list-controls",
	template: `
		<div class="col">
			<div ngbDropdown class="d-inline-block">
				...
				<div ngbDropdownMenu aria-labelledby="actionDropdown" class="dropdown-menu">
					<button type="button" ngbDropdownItem class="btn btn-sm" (click)="Edit()">
						<i class="ri-edit-line align-bottom me-2 text-muted"></i> Edit
					</button>
					<button type="button" ngbDropdownItem class="btn btn-sm" (click)="Delete()">
...
export class ClientsDocumentsListControlsComponent {
	private params!: ICellRendererParams;
	private comp!: ClientsDocumentsComponent;
