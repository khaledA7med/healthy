...
export class LibraryOfDeductiblesComponent implements OnInit {
	constructor() {}
	searchURI: string = ApiRoutes.masterTables.production.libraryOfDeductibles.search;
	...
	deleteURI: string = ApiRoutes.masterTables.production.libraryOfDeductibles.delete;
	ngOnInit(): void {}
}
