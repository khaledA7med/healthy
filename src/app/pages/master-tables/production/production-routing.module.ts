...
const routes: Routes = [
  {
    ...
    loadChildren: () =>
      import("./library-of-covers/library-of-covers.module").then(
        (m) => m.LibraryOfCoversModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        "./library-of-interests-insured/library-of-interests-insured.module"
      ).then((m) => m.LibraryOfInterestsInsuredModule),
    canActivate: [
      () =>
        MasterTablesGuard([
          MasterTablePermissions.ChMasterTabels,
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./library-of-terms/library-of-terms.module").then(
        (m) => m.LibraryOfTermsModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./library-of-deductibles/library-of-deductibles.module").then(
        (m) => m.LibraryOfDeductiblesModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./library-of-exclusions/library-of-exclusions.module").then(
        (m) => m.LibraryOfExclusionsModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./library-of-warranties/library-of-warranties.module").then(
        (m) => m.LibraryOfWarrantiesModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./life-plan/life-plan.module").then((m) => m.LifePlanModule),
    canActivate: [
      () =>
        MasterTablesGuard([
          MasterTablePermissions.ChMasterTabels,
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./vehicles-make/vehicles-make.module").then(
        (m) => m.VehiclesMakeModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./vehicles-type/vehicles-type.module").then(
        (m) => m.VehiclesTypeModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./vehicles-colors/vehicles-colors.module").then(
        (m) => m.VehiclesColorsModule
      ),
    canActivate: [
      () =>
        MasterTablesGuard([
