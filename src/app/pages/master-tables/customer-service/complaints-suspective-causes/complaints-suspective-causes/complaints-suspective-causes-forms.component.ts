import { ComplaintsSuspectiveCausesComponent } from "./complaints-suspective-causes.component";
...
@Component({
  selector: "app-complaints-suspective-causes-forms",
  template: `
    <div class="col">
...
export class ComplaintsSuspectiveCausesFormsComponent {
  private params!: ICellRendererParams;
  private comp!: ComplaintsSuspectiveCausesComponent;
