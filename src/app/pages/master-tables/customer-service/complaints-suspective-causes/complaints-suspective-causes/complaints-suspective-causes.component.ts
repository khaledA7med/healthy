...
export class ComplaintsSuspectiveCausesComponent implements OnInit, OnDestroy
{
  ...
  submitComplaintsSuspectiveCausesData (form: FormGroup)
  {
    ...
    this.eventService.broadcast(reserved.isLoading, true);
    let sub = this.ComplaintSuspectiveCausesService.saveComplaintSuspectiveCauses(data).subscribe(
  ...
  {
    let sub = this.ComplaintSuspectiveCausesService.DeleteComplaintSuspectiveCauses(sno).subscribe(
