...
@Component({
	...
	template: `
		<div class="ag-theme-alpine" appTableView>
			<ag-grid-angular class="gridScrollbar" style="width: 100%; height: 70vh" [gridOptions]="gridOpts"> </ag-grid-angular>
		</div>
	`,
	styles: [],
})
export class ClaimsRequestListComponent implements OnDestroy {
	...
	constructor(private tableRef: ElementRef, private message: MessagesService, private claimService: ClaimsService) {}
