			...
			<div ngbDropdown class="d-inline-block">
				...
				<div ngbDropdownMenu aria-labelledby="actionDropdown" class="dropdown-menu">
					...
					<button
						...
						(click)="Edit()"
						class="btn btn-sm"
						*ngIf="!(comp.permissions$ | async)?.includes(comp.uiState.privileges.ChClaimsManagementSystemReadOnly)">
					...
					<li>
						...
						<ul class="dropdown-menu dropdown-submenu">
							<li>
								<button class="btn btn-sm dropdown-item" (click)="showEmail('client')">Client</button>
							</li>
							<li>
								<button class="btn btn-sm dropdown-item" (click)="showEmail('insurer')">Insurer</button>
							</li>
						</ul>
					</li>
				</div>
