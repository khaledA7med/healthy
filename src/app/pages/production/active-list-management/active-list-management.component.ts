...
} from "src/app/shared/app/models/Production/i-active-list-filters";
  ...
  dataSource: IDatasource = {
    getRows: (params: IGetRowsParams) => {
      ...
      let sub = this.productionService
        .getAllActivePolicies(this.uiState.filters)
        .subscribe((res: HttpResponse<IBaseResponse<IActivePolicy[]>>) => {
          if (res.status) {
