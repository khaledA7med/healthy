...
import { ProductionFormGuard, ProductionGuard } from "src/app/core/guards/production/production.guard";
...
const routes: Routes = [
	...
	},
	{
		...
		loadChildren: () => import("./policies-forms/policies-forms.module").then((m) => m.PoliciesFormsModule),
		canActivate: [() => ProductionGuard([ProductionPermissions.ChProduction, ProductionPermissions.ChEntryCorrection])],
	},
	{
		path: AppRoutes.Production.makeInvoice + ":invoice/:serial/:reqno/:endorsType",
		data: {
			title: "Make Invoice",
		},
		loadChildren: () => import("./policies-forms/policies-forms.module").then((m) => m.PoliciesFormsModule),
	...
	},
	{
		...
		canActivate: [() => ProductionGuard([ProductionPermissions.ChProduction, ProductionPermissions.ChChangeProducerComm])],
	},
	{
