...
export class PoliciesFormsComponent implements OnInit, OnDestroy {
	...
	sendFormRequestData(): void {
		...
		for (let i = 0; i < terms.length; i++) {
			...
			formData.append(`PaymentTermsList[${i}].percentage`, terms[i].percentage?.toString()! ?? "");
			formData.append(`PaymentTermsList[${i}].amount`, terms[i].amount?.toString()! ?? "");
			formData.append(`PaymentTermsList[${i}].policyFees`, terms[i].policyFees?.toString()! ?? "");
			formData.append(`PaymentTermsList[${i}].vatAmount`, terms[i].vatAmount?.toString()! ?? "");
		}
		...
		for (let i = 0; i < commissions.length; i++) {
			...
			formData.append(`ProducersCommissionsList[${i}].percentage`, commissions[i].percentage?.toString()! ?? "");
			formData.append(`ProducersCommissionsList[${i}].amount`, commissions[i].amount?.toString()! ?? "");
		}
