	...
	template: `
		<div class="col d-flex align-items-center justify-content-center">
			<div ngbDropdown class="d-inline-block">
				<button type="button" class="btn btn-sm btn-ghost-secondary btn-sm waves-effect rounded-pill" id="actionDropdown" ngbDropdownToggle>
				...
				<div ngbDropdownMenu aria-labelledby="actionDropdown">
					<button
						...
						(click)="Edit()"
						class="btn btn-sm"
						*ngIf="!(permissions$ | async)?.includes(privileges.ChClientsRegistryAdministratorReadOnly)">
						Edit
					</button>
