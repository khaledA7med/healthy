				...
				<div ngbDropdownMenu aria-labelledby="actionDropdown" class="dropdown-menu">
					...
					<li>
						...
						<ul class="dropdown-menu dropdown-submenu">
							<li>
								<button (click)="changeLeadStatus(leadStatus.Prospect)" class="btn btn-sm dropdown-item">
									{{ leadStatus.Prospect }}
								</button>
							</li>
							<li>
								<button (click)="changeLeadStatus(leadStatus.Confirmed)" class="btn btn-sm dropdown-item">
									{{ leadStatus.Confirmed }}
								</button>
							</li>
							<li>
								<button (click)="changeLeadStatus(leadStatus.Quoting)" class="btn btn-sm dropdown-item">
									{{ leadStatus.Quoting }}
								</button>
							</li>
							<li>
							...
							<li>
								<button (click)="changeLeadStatus(leadStatus.Lost)" class="btn btn-sm dropdown-item">
									{{ leadStatus.Lost }}
								</button>
							</li>
							<li>
...
export class BusinessDevelopmentControlsComponent {
	...
	Edit() {
		this._Router.navigate([AppRoutes.BusinessDevelopment.edit, this.params.data.identity]);
	}
