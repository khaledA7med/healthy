        ...
        >
          ...
          <li>
            ...
            <ul class="dropdown-menu dropdown-submenu">
              <li>
                <button
                  (click)="changeLeadStatus(leadStatus.Prospect)"
              ...
              <li>
                <button
                  (click)="changeLeadStatus(leadStatus.Confirmed)"
                  class="btn btn-sm dropdown-item"
                >
              ...
              <li>
                <button
                  (click)="changeLeadStatus(leadStatus.Quoting)"
                  class="btn btn-sm dropdown-item"
                >
                  {{ leadStatus.Quoting }}
                </button>
              ...
              <li>
                <button
                  (click)="changeLeadStatus(leadStatus.PendingwithUnderwriting)"
                  class="btn btn-sm dropdown-item"
                >
              ...
              <li>
                <button
                  (click)="changeLeadStatus(leadStatus.Lost)"
                  class="btn btn-sm dropdown-item"
                >
                  {{ leadStatus.Lost }}
                </button>
              ...
              <li>
                <button
                  (click)="
                    changeLeadStatus(leadStatus.WaitingForClientFeedback)
                  "
                  class="btn btn-sm dropdown-item"
                >
