...
import {
  businessDevelopmentCols,
  columnsToExport,
} from "src/app/shared/app/grid/businessDevelopmentCols";
import {
  IBaseMasterTable,
  ...
  implements OnInit, OnDestroy
{
  ...
  onGridReady(param: GridReadyEvent) {
    ...
    this.gridApi.setDatasource(this.dataSource);
    if ((this, this.uiState.salesLead.list.length > 0))
  ...
  modifyFilterReq() {
    this.uiState.filters = {
      ...
      savedOnFrom: this.appUtils.dateFormater(
        this.f.savedOnFrom?.value!
      ) as any,
