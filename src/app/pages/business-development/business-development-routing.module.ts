...
const routes: Routes = [
  ...
  {
    path: AppRoutes.BusinessDevelopment.dashboard,
    data: { title: "Business Development Dashboard" },
    loadChildren: () =>
      import(
        "./dashboard-business-development/dashboard-business-development.module"
      ).then((m) => m.DashboardBusinessDevelopmentModule),
  },
  {
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        "./business-development-prospects-reports/business-development-prospects-reports.module"
      ).then((m) => m.BusinessDevelopmentProspectsReportsModule),
  },
  {
    ...
    loadChildren: () =>
      import(
        "../production/production-renewal-report/production-renewal-report.module"
